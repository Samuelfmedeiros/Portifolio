    ...
    <div className="py-6 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          ...
          <div ref={scrollRef} className="flex gap-3 overflow-x-auto hide-scrollbar pb-2" style={{ touchAction: "pan-y", overscrollBehaviorX: "contain", WebkitOverflowScrolling: "touch" }}>
            {repos.map((repo) => (
