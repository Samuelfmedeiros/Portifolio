    ...
    <section id="contact" className="py-12 px-4 md:px-6">
      ...
      <div className="max-w-lg mx-auto mb-6">
        <a
          ...
          className="flex items-center justify-center gap-3 bg-green-600 dark:bg-green-500 hover:bg-green-700 dark:hover:bg-green-600 text-white font-mono text-sm font-semibold py-3 px-6 rounded-lg transition-colors"
        >
      ...
      <GlassCard className="max-w-lg mx-auto text-sm md:text-base">
        ...
        {status === "sent" ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {status === "error" && (
              <p className="text-xs font-mono text-red-600 dark:text-red-400 text-center">
