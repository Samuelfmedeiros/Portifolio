  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-6">
      ...
      <motion.div
        ...
        className="absolute top-24 left-6 right-6 glass rounded-lg px-6 py-3 flex items-center justify-between font-mono text-xs border-[var(--border)]"
      >
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1 text-[var(--accent)]">
            <Cpu className="w-3 h-3" /> SYS:ONLINE
          </span>
        ...
        <div className="flex items-center gap-2">
          <span className="text-[var(--text-secondary)]">SCROLL</span>
          ...
          <span className="text-[var(--accent)] tabular-nums w-8 text-right">{scrollPercent}%</span>
        </div>
      </motion.div>
      ...
      <div className="text-center max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="h-px w-32 mx-auto bg-gradient-to-r from-transparent via-[var(--accent)] to-transparent mb-6" />
          <p className="text-xl md:text-2xl font-mono text-[var(--text-secondary)] tracking-wider">
        ...
        >
          {["BI & SQL", "Python", "Machine Learning", "Next.js", "LLMs Locais"].map((skill) => (
            <span
              key={skill}
              className="glass px-4 py-2 rounded-full text-sm font-mono text-[var(--accent)] border-[var(--border)]"
            >
              {skill}
            </span>
          ))}
