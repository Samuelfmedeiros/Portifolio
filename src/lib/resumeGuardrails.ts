...
// ─── Anti-placeholder: eco do template do prompt ────────────────
// Modelos fracos às vezes devolvem o EXEMPLO de formato do prompt em vez de
// gerar o currículo ("cargo ajustado para a vaga", "skill1", "bullet1").
// Isso passa pela validação de campos imutáveis e viraria um PDF teatral —
// então é tratado como falha da IA.
const PROMPT_ECHO_MARKERS = [
  ...
  "requisito da vaga → evidência real do cv",
  "job requirement → real resume evidence",
  "skill1",
  "skill2",
  "bullet1",
  "bullet2",
